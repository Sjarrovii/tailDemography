...
```
#Reviewing filters
- The values here can help us to determine observatgions that don't need to be reviewed individually
```{r}
...
mycombfile[which(mycombfile$new.recap=="recap " | mycombfile$new.recap=="reecap" | mycombfile$new.recap=="r"),"forceRecap"]<-T
...
# write.csv2(mycombfile,"mapped data.csv",sep = ",")
```
